...
# use scikit-learn's SVC object, which is a non-linear "kernel" SVM 
...
# Compare the decision boundaries of the two trained models: are they the same?

# GridSearchCV warm-up
#  increasing the RBF kernel hyperparameter gamma increases training accuracy. Consider the trade off between overfitting and accuracy
